...
<div class="py-16 bg-primary relative overflow-hidden text-center"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div x-data="{ count: 0, target: 1200, started: false }"
                ...
                <div class="text-4xl md:text-5xl lg:text-6xl font-black text-secondary mb-2 drop-shadow-md flex justify-center items-center gap-1"
                    dir="ltr">
                    +<span x-text="count">0</span>
                </div>
                <div class="text-sm md:text-lg font-medium text-white/90">{{ __('home.stats.students') }}</div>
            </div>
            ...
            <div x-data="{ count: 0, target: 85, started: false }"
                ...
                <div class="text-sm md:text-lg font-medium text-white/90">{{ __('home.stats.teachers') }}</div>
            </div>
            ...
            <div x-data="{ count: 0, target: 450, started: false }"
                ...
                <div class="text-sm md:text-lg font-medium text-white/80">{{ __('home.stats.graduates') }}</div>
            </div>
            ...
            <div x-data="{ count: 0, target: 15, started: false }"
                ...
                <div class="text-sm md:text-lg font-medium text-white/80">{{ __('home.stats.years') }}</div>
            </div>
